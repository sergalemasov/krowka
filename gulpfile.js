...
module.exports = {
    serve: series(clean, parallel(htmlTask, cssTask, imgTask, jsTask, fontsTask), serve),
    default: series(enableProd, clean, parallel(htmlTask, cssTask, imgTask, jsTask, fontsTask))
};
